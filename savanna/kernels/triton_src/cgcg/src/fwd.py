...
from savanna.kernels.triton_src.cgcg.src.kernel_utils import AutotunedResult
...
# # For kernel versions v1 / v2 -- not used for now
# def _two_pass_fwd_grouped(
#     x: torch.Tensor,
#     B: torch.Tensor,
#     C: torch.Tensor,
#     h: torch.Tensor,
#     y: torch.Tensor = None,
#     return_bx: bool = False,
...
#             assert CHUNK_TILES_PER_PROGRAM is not None
#             assert schedule == "default", "schedule must be default for version v2"
#             kernel: triton.runtime.JITFunction = _two_pass_fwd_refactor_kernel
#         else:
...
#             if return_kernel:
#                 return y, T, T_hat, y2, bx, bx_lag, compiled_kernel
#             return y, T, T_hat, y2, bx, bx_lag
#         else:
#             # Autotune path
...
#             if return_kernel:
#                 return y, T, T_hat, y2, bx, bx_lag, compiled_kernel, autotune_result

#             return y, T, T_hat, y2, bx, bx_lag, autotune_result
