...
@dataclass(eq=False)
class FwdKernelConfigRefactor(KernelConfig):
    name: str = "fwd"
...
@dataclass
class BwdKernelConfigRefactor:
    name: str = "bwd-refactor"

    pre_conv_BLOCK_X: int = 128
    pre_conv_BLOCK_Y: int = 128
    pre_conv_num_warps: int = 4
    post_conv_BLOCK_X: int = 128
    post_conv_BLOCK_Y: int = 128
    post_conv_num_warps: int = 4