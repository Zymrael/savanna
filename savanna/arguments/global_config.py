...
class GlobalConfigModel(GlobalConfigTemplate):
    ...
    ff_dim: int = None
    """
    Manually set ffn dimension for ParallelGLU weights.
    """
...
class GlobalConfigLogging(GlobalConfigTemplate):
    ...
    save_logits: str = None
    """
    Save logits to path, only rank 0 will save
    """
...
class GlobalConfigProfiler(GlobalConfigTemplate):
    ...
    memory_snapshot_folder: str = "memory_snapshots"
    """
    ...
    memory_snapshot_num_iters: int = 3
    """
    Number of iterations to save memory snapshots.
    """
...
@dataclass
class GlobalConfigRetrieval(GlobalConfigTemplate):
    """
    Retrieval arguments and other inference args
    """
    input_path: str = None

    output_path: str = None

    enable_haystack: bool = False
    ...
    haystack_batch_size: int = None

    background_sequence_path: str = "/lustre/fs01/portfolios/dir/users/jeromek/savanna-test/evals/data/random_megabase.txt"

    model_name: str = "evo2"

    output_dir: str = "/lustre/fs01/portfolios/dir/users/jeromek/savanna-test/evals/figures/needle_in_a_haystack"
