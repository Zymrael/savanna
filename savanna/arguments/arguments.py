...
class GlobalConfig(*BASE_CLASSES):
    ...
    def consume_deepy_args(cls):
        ...
        group.add_argument("--wandb_project", type=str, help="Weights & Biases project name.", default="savanna")
        ...
        if global_config.use_wandb:
            ...
            # @jeromeku: Commented this out since it is redundant
            # global_config.wandb_group 
            # += "_" + wandb.util.generate_id()
    ...
    def calculate_derived(self):
        ...
        if global_num_gpus is None:
            if self.hostfile is not None or os.path.exists(runner.DLTS_HOSTFILE):
